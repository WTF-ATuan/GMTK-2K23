...
public class Timer : MonoBehaviour
{
	...
	/// <summary>
	/// Runs the timer because a timer of 0 duration doesn't really make sense,
	/// the timer only runs if the total seconds is larger than 0
	/// This also makes sure the consumer of the class has actually set the duration to something higher than 0
	/// </summary>
	public void Run()
    {	
